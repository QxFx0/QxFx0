...
phase-2 persistence** (WP1–WP5 + GuardrailState/CalibrationLog in
SystemState).  Fast-test count increased from 484 → 515 and
full-test count from 611 → 642 due to learning-loop regression
checks and persistence/rollback/continuity coverage.
...
| 2 | `cabal test qxfx0-test-fast` | `cabal test qxfx0-test-fast --ghc-options="-O0" +RTS -M8G` | 0 | **PASS** | 515/515 cases, 0 errors, 0 failures |
| 3 | `cabal test qxfx0-test` (meta) | `cabal test qxfx0-test --ghc-options="-O0" +RTS -M8G` | 0 | **PASS** | 642/642 cases, 0 errors, 0 failures |
...
# Expected: Cases: 515  Tried: 515  Errors: 0  Failures: 0

# Meta suite (low-RAM safe, longer):
cabal test qxfx0-test --ghc-options="-O0" +RTS -M8G
# Expected: Cases: 642  Tried: 642  Errors: 0  Failures: 0
