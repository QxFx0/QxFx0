...
локального bump, на глаз ничего не меняется. Калибровка была
заблокирована отсутствием `data/calibration_corpus/` — условие СНЯТО
2026-09-21 (1030 записей, 130 меток, train_eligible 125); блокер теперь
в объекте (веса плоски по вариантам, см. CALIBRATION_REPORT.md
batch3-секцию), а не в данных.
