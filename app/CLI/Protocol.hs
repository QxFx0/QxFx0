...
healthJsonPairs health sessionId dbPath =
  ...
  , "gfmap_ok" .= Runtime.shGfMapOk health
  , "gfmap_status" .= Runtime.shGfMapStatus health
  , "gfmap_entries" .= Runtime.shGfMapEntries health
  , "gfmap_issue" .= Runtime.shGfMapIssue health
