...
import Test.Suite.AutonomousLoop (autonomousLoopTests)
...
import Test.Suite.ActiveCoverageGap (activeCoverageGapTests)
import Test.Suite.AutonomousIntegration (autonomousIntegrationTests)
import Test.Suite.AutonomousSafety (autonomousSafetyTests)
import Test.Suite.BeliefRevision (beliefRevisionTests)
import Test.Suite.LearningEvents (learningEventsTests)
import Test.Suite.LogicInference (logicInferenceTests)
import Test.Suite.RuntimeLLMFeedback (runtimeLLMFeedbackTests)
import Test.Suite.RuntimeProjection (runtimeProjectionTests)
import Test.Suite.PromotionRuntime (promotionRuntimeTests)
import Test.Suite.Anomaly (anomalyTests)
import Test.Suite.StatePersistence (replayTraceCompatibilityTests)
